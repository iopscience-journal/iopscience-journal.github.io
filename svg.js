!(function () {
  ...
  var t,
    ...
    ft = {
                        ...
                        try {
                          for (
                            var x =
                                ((i = void 0),
                                a(
                                  Object.keys(h[f]).map(function (t) {
                                    return parseInt(t);
                                  })
                                )),
                              _ = x.next();
                            ...
                            t[(g = _.value)] = this.smpChar(v + h[f][g]);
                          }
                        } catch (t) {
                          i = { error: t };
                        } finally {
          ...
          f = (function (t) {
            ...
            return (
              ...
              (e.prototype.setScale = function (t) {
                ...
                1 !== e &&
                  this.adaptor.setStyle(t, "fontSize", (0, u.percent)(e));
              }),
              ...
              (e.prototype.getMetricMaps = function (t) {
                ...
                try {
                  for (
                    ...
                    try {
                      for (
                        var S = ((i = void 0), s(f[w].keys())), O = S.next();
                        !O.done;
                        O = S.next()
                      ) {
                        var C = O.value;
                ...
                try {
                  for (
                    ...
                    try {
                      for (
                        var P = ((u = void 0), s(f[w].values())), A = P.next();
                        !A.done;
                        A = P.next()
                      ) {
                        C = A.value;
        ...
        var x = (function (t) {
          ...
          return (
            ...
            (e.prototype.px = function (t, e) {
              return (
                void 0 === e && (e = -f.BIGDIMEN), f.px(t, e, this.metrics.em)
              );
            }),
          ...
          return (function (t) {
            ...
            return (
              ...
              (e.prototype.getParameters = function () {
                ...
                void 0 !== r &&
                  (this.thickness = this.length2em(r, u.THICKNESS));
                ...
                try {
                  for (
                    ...
                    if (this.notations[a]) {
                      ...
                      try {
                        for (
                          var l = ((r = void 0), h(s.split(/ /))), c = l.next();
                          !c.done;
                          c = l.next()
                        ) {
                          var u = c.value;
                  ...
                  try {
                    for (
                      ...
                      l.node.isKind("mprescripts")
                        ? (n = "psubList")
                        : (o[n].push(l.getOuterBBox()), (n = e.NextScript[n]));
                    }
                  } catch (e) {
                    t = { error: e };
                  } finally {
                      ...
                      try {
                        for (
                          ...
                          if (v.value >= p)
                            return (
                              l && y && y--,
                              (this.variant = this.font.getSizeVariant(f, y)),
                              (this.size = y),
                              void (
                                d.schar &&
                                d.schar[y] &&
              ...
              return (
                ...
                (e.prototype.stretchChildren = function (t) {
                  ...
                  if (p && d > 1) {
                    if (null === t) {
                      ...
                      try {
                        for (
                          ...
                          var b = 0 === (O = g.value.childNodes[0]).stretch.dir;
                          if (m || b) {
                            var x = O.getBBox(b),
                              _ = x.h,
                              M = x.d;
                    ...
                    try {
                      for (var w = n(l), S = w.next(); !S.done; S = w.next()) {
                        var O;
              ...
              return (
                  ...
                  if (this.node.isKind("munderover"))
                    if (this.node.isKind("mover"))
                      ...
                      (this.isLineAbove = this.isLineAccent(this.overChild)),
                        (this.isLineBelow = this.isLineAccent(this.underChild));
                    }
                }),
                ...
                (e.prototype.getUnderKV = function (t, e) {
                  var r = this.node.attributes.get("accentunder"),
                    ...
                    l =
                      (r
                        ? s
                        : Math.max(o.big_op_spacing2, o.big_op_spacing4 - n)) -
                      a;
                ...
                (e.prototype.stretchChildren = function () {
                  ...
                  if (h && u > 1) {
                    ...
                    try {
                      for (var x = s(a), _ = x.next(); !_.done; _ = x.next()) {
                        var M;
                        (M = _.value)
                          .coreMO()
      ...
      9708: function (t, e, r) {
        ...
        (e.SVGFontData = h),
          (e.AddPaths = function (t, e, r) {
            ...
            try {
              for (
                var s = l(Object.keys(e)), c = s.next();
                !c.done;
                c = s.next()
              ) {
                var u = c.value,
            ...
            try {
              for (
                var d = l(Object.keys(r)), f = d.next();
                !f.done;
                f = d.next()
              ) {
            ...
            return (
              ...
              (e.prototype.handleScale = function () {
                if (1 !== this.bbox.rscale) {
                  var t =
                    "scale(" + this.fixed(this.bbox.rscale / 1e3, 3) + ")";
                  ...
                  try {
                    for (
                      ...
                      m &&
                        ...
                        (c[f] =
                          this.styles.get(y + "Color") || "currentColor"));
                    }
                  } catch (e) {
                    t = { error: e };
                  } finally {
              ...
              (e.prototype.toSVG = function (t) {
                ...
                if (0 !== o.length)
                  if ("-explicitFont" === n)
                    ...
                    var s = 0;
                    try {
                      for (var l = i(a), c = l.next(); !c.done; c = l.next()) {
                        var h = c.value;
                    ...
                    function (t, e) {
                      ...
                      if (r) {
                        ...
                        if (r.node.isKind("mtext")) {
                          ...
                          t.adaptor.insert(t.svg("title", {}, [t.text(n)]), o);
                        } else {
                          var i = t.adaptor,
                            a = t.jax.container,
                            ...
                            l = t.html("mjx-tool", {}, [t.html("mjx-tip")]),
                            c = i.append(
                              o,
                              t.svg(
                                "foreignObject",
                                ...
                                e.hoverTimer.set(
                                  ...
                                  setTimeout(function () {
                                    ...
                                    var e = i.nodeBBox(l),
                                      ...
                                      o =
                                        (r.right - e.left) / t.metrics.em +
                                        t.dx,
                                      n =
                                        (r.bottom - e.bottom) / t.metrics.em +
                                        t.dy;
                                    i.setStyle(l, "left", t.px(o)),
                                      i.setStyle(l, "top", t.px(n));
                                  }, e.postDelay)
                                ),
                                r.stopPropagation();
                            }),
                ...
                if ("none" !== this.node.attributes.get("columnlines")) {
                  ...
                  if (e)
                    for (
                      ...
                      (i += r[a] + n[a] + r[a + 1]),
                        "none" !== e[a] &&
                          this.adaptor.append(t, this.makeVLine(i, e[a], o[a])),
                        (i += o[a]);
                }
              }),
                ...
                if ("none" !== this.node.attributes.get("rowlines")) {
                  ...
                  if (e)
                    for (
                      ...
                      (h -= l[u] + d + f + l[u + 1]),
                        "none" !== e[u] &&
                          this.adaptor.append(t, this.makeHLine(h, e[u], c[u])),
                        (h -= c[u]);
                    }
                }
              }),
              ...
              if (this.hasMovableLimits()) t.prototype.toSVG.call(this, e);
                ...
                var p = this.getDelta(),
                  ...
                  y = i(
                    this.getDeltaW(
                      [c, u, h],
                      [0, this.isLineBelow ? 0 : -p, this.isLineAbove ? 0 : p]
                    ),
                    3
                  ),
                  m = y[0],
      ...
      7988: function (t, e) {
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.MmlMphantom =
            MathJax._.core.MmlTree.MmlNodes.mphantom.MmlMphantom);
      },
      4664: function (t, e) {
        Object.defineProperty(e, "__esModule", { value: !0 }),
  ...
  (mt.n = function (t) {
    ...
    MathJax.startup &&
      (MathJax.startup.registerConstructor("svg", k.SVG),
